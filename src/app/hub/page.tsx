...
const MODULES = [
  ...
  },
  {
    ...
    href: '/tracker/strategy',
    description: 'Long-term plans, pillars, milestones.',
    accent: 'bg-violet-600',
    softBg: 'bg-violet-50/70',
    softBorder: 'border-violet-100',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M3 21V4a1 1 0 011-1h12l-2.5 4L16 11H4" />
      </svg>
    ),
  },
  {
    ...
    description: 'Every event, open or closed.',
    accent: 'bg-amber-500',
